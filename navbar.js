...
<nav class="fixed top-0 w-full z-50 nav-blur border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
        ...
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-center space-x-8">
                    ...
                    <a href="resources/Siham_Elmali_resume.pdf" target="_blank" class="flex items-center gap-2 text-sm font-medium text-charcoal dark:text-gray-300 hover:text-copper transition-colors">
                        Resume
    ...
    <div id="mobile-menu" class="md:hidden hidden bg-white dark:bg-navy border-t border-gray-200 dark:border-gray-700 absolute w-full shadow-xl">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="resources/Siham_Elmali_resume.pdf" target="_blank" class="block px-3 py-2 text-charcoal dark:text-gray-300 hover:text-copper flex items-center gap-2">
